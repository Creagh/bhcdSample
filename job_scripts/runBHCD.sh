...
java -cp build/install/blangBHCD/lib/\* bhcd.BHCD --model.graph.file data/terrorists/terrorist_pairs.csv --experimentConfigs.recordGitInfo false --treatNaNAsNegativeInfinity true --checkIsDAG false --engine PT --engine.nChains 50 --engine.nScans 200000 --engine.initialization COPIES --engine.usePriorSamples true --postProcessor DefaultPostProcessor --model.theta 0.0 --engine.thinning 10 --engine.nPassesPerScan 9