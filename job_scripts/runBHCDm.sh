...
java -cp build/install/blangBHCD/lib/\* bhcd.BHCD --model.graph.file data/metabolic/links_tpa_reduced.csv --experimentConfigs.recordGitInfo false --treatNaNAsNegativeInfinity true --checkIsDAG false --engine PT --engine.nChains 60 --engine.nScans 100000 --engine.initialization COPIES --engine.usePriorSamples true --postProcessor DefaultPostProcessor --model.theta 0.0 --engine.thinning 10 --engine.nPassesPerScan 6